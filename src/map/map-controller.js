...
export class MapController {
  ...
  openInfoWindow(layerId, infoWindow, feature, event = {}) {
    this.syncInfoWindowManager()
    this.infoWindowManager.open(layerId, infoWindow, feature, event)
    this.syncInfoWindowFields()
  }

  closeInfoWindow() {
    this.syncInfoWindowManager()
    if (!this.infoWindowManager.infoWindow && this.infoWindow) {
      this.infoWindowManager.infoWindow = this.infoWindow
    }
    if (!this.infoWindowManager.infoWindowMarker && this.infoWindowMarker) {
      this.infoWindowManager.infoWindowMarker = this.infoWindowMarker
    }
    this.infoWindowManager.close()
    this.syncInfoWindowFields()
  }

  syncInfoWindowManager() {
    this.infoWindowManager.AMap = this.AMap
    this.infoWindowManager.map = this.map
  }

  syncInfoWindowFields() {
    this.infoWindow = this.infoWindowManager.infoWindow
    this.infoWindowMarker = this.infoWindowManager.infoWindowMarker
    this.infoWindowActionDisposer = this.infoWindowManager.infoWindowActionDisposer
  }
